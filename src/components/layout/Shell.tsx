      ...
      <header className={`border-b border-[var(--color-border)] bg-[var(--color-surface)] sticky top-0 z-50 px-4 h-12 flex items-center justify-between ${fullscreenMode ? 'hidden' : ''}`}>
        ...
        <div className="flex items-center space-x-3">
          ...
          {user && (
            ...
            >
              <span>{user.chessComUsername ? user.chessComUsername : '+ Link'}</span>
            </Link>
          )}
            ...
            <div className="relative">
              ...
              {userDropdownOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-1.5 w-48 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)] p-1.5 z-20">
                    <div className="px-3 py-1.5 border-b border-[var(--color-border)] text-[10px] text-[var(--color-text-muted)]">
                      Logged in as <p className="font-semibold text-white truncate text-xs">
