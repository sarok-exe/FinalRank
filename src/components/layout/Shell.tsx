...
export default function Shell({ children }: ShellProps) {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)] text-white flex flex-col font-sans" id="app-shell">
      <header className={`border-b border-[var(--color-border)] bg-[var(--color-surface)] sticky top-0 z-50 px-6 h-16 flex items-center justify-between w-full ${fullscreenMode ? 'hidden' : ''}`}>
