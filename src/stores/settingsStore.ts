...
export const THEME_PRESETS: Record<string, {
  ...
  olive: {
    ...
    highlightColors: { moveTrail: '#dda15e', selectedSquare: '#bc6c25', rightClick: '#e53935' },
    mood: 'warm',
  ...
  dark: {
    ...
    highlightColors: { moveTrail: '#e0e0e0', selectedSquare: '#7c7c7c', rightClick: '#e53935' },
    mood: 'professional',
  ...
  ember: {
    ...
    highlightColors: { moveTrail: '#fb4934', selectedSquare: '#d65d0e', rightClick: '#e53935' },
    mood: 'energetic',
    suggestedBoardColor: 'brown',
  },
  ocean: {
    ...
    highlightColors: { moveTrail: '#83a598', selectedSquare: '#458588', rightClick: '#e53935' },
    mood: 'professional',
  ...
  forest: {
    ...
    highlightColors: { moveTrail: '#8ec07c', selectedSquare: '#689d6a', rightClick: '#e53935' },
    mood: 'calm',
  ...
  'leafy-green': {
    ...
    highlightColors: { moveTrail: '#ecf39e', selectedSquare: '#90a955', rightClick: '#e53935' },
    mood: 'calm',
    suggestedBoardColor: 'green',
  },
  'neutral-harmony': {
    ...
    highlightColors: { moveTrail: '#f2cc8f', selectedSquare: '#e07a5f', rightClick: '#e53935' },
    mood: 'calm',
  ...
  'nature-harmony': {
    ...
    highlightColors: { moveTrail: '#bcbd8b', selectedSquare: '#717744', rightClick: '#e53935' },
    mood: 'calm',
    suggestedBoardColor: 'green',
  },
  'soft-lavender': {
    ...
    highlightColors: { moveTrail: '#c9ada7', selectedSquare: '#9a8c98', rightClick: '#e53935' },
    mood: 'calm',
    suggestedBoardColor: 'elegant',
  },
  'cherry-blossom': {
    ...
    highlightColors: { moveTrail: '#ffccd5', selectedSquare: '#ff4d6d', rightClick: '#e53935' },
    mood: 'calm',
  ...
  'gothic-glam': {
    ...
    highlightColors: { moveTrail: '#da4167', selectedSquare: '#832161', rightClick: '#e53935' },
    mood: 'energetic',
    suggestedBoardColor: 'charcoal',
  },
  'fiery-ocean': {
    ...
    highlightColors: { moveTrail: '#669bbc', selectedSquare: '#c1121f', rightClick: '#e53935' },
    mood: 'energetic',
    suggestedBoardColor: 'blue',
  },
  'warm-autumn': {
    ...
    highlightColors: { moveTrail: '#fcbf49', selectedSquare: '#f77f00', rightClick: '#e53935' },
    mood: 'energetic',
    suggestedBoardColor: 'brown',
  },
  'autumn-sunset': {
    ...
    highlightColors: { moveTrail: '#fcb9b2', selectedSquare: '#b23a48', rightClick: '#e53935' },
    mood: 'energetic',
    suggestedBoardColor: 'brown',
  },
  'deep-sea': {
    ...
    highlightColors: { moveTrail: '#8bbeb2', selectedSquare: '#384e77', rightClick: '#e53935' },
    mood: 'professional',
    suggestedBoardColor: 'blue',
  },
  'mystic-mauve': {
    ...
    highlightColors: { moveTrail: '#96705b', selectedSquare: '#684756', rightClick: '#e53935' },
    mood: 'professional',
    suggestedBoardColor: 'elegant',
  },
  'coastal-blues': {
    ...
    highlightColors: { moveTrail: '#89c2d9', selectedSquare: '#2a6f97', rightClick: '#e53935' },
    mood: 'professional',
    suggestedBoardColor: 'blue',
  },
  'golden-twilight': {
    ...
    highlightColors: { moveTrail: '#ffd60a', selectedSquare: '#ffc300', rightClick: '#e53935' },
    mood: 'professional',
  ...
  'fresh-greens': {
    ...
    highlightColors: { moveTrail: '#a7c957', selectedSquare: '#6a994e', rightClick: '#e53935' },
    mood: 'warm',
  ...
  'mocha-latte': {
    ...
    highlightColors: { moveTrail: '#f2f4f3', selectedSquare: '#a9927d', rightClick: '#e53935' },
    mood: 'warm',
    suggestedBoardColor: 'elegant',
  },
  chesscom: {
    // Chess.com-inspired dark palette: keeps the app's dark chrome but adopts
    // chess.com's real design tokens (dumped from chess.com's global CSS) —
    // green-300 #81b64c primary buttons, link blue #2b8dd4 accents, warm dark
    // chrome (#262421 bg / #312e2b panels / #46413f borders), classic
    // green/cream board (#eeeed2 / #769656) and yellow highlight family.
    siteColors: { primary: '#81b64c', secondary: '#204227', accent: '#2b8dd4', background: '#262421', surface: '#312e2b', text: '#e7e3dc', textMuted: '#bababa', border: '#46413f' },
    boardCustomColors: { lightSquare: '#eeeed2', darkSquare: '#769656' },
    highlightColors: { moveTrail: '#ecd27c', selectedSquare: '#f5f682', rightClick: '#e53935' },
    mood: 'professional',
    suggestedBoardColor: 'green',
  },
};
